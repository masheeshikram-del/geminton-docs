...
When you use certificate capture or analysis, the App may send the certificate image to Google Cloud Vision to obtain text (optical character recognition) and help fill or suggest fields. Only images you submit through this feature are involved.

How Google processes that content is described in Google Cloud and Google APIs terms and privacy materials.

If future versions add other services that process your images or text (for example additional cloud or AI providers), this policy will be updated to name them and describe what is shared.
